    ...
    for idx in range(len(List_Row)):
        ...
        if idx < colNum:
            if idx % colNum == 0:
                ...
                DictPerformance_acc['0.0023'].append(List_Row[idx])
            ...
            if idx % colNum == 0:
                ...
                DictPerformance_se['0.0023'].append(List_Row[idx])
            ...
            if idx % colNum == 0:
                ...
                DictPerformance_spe['0.0023'].append(List_Row[idx])
        elif idx >= 3*colNum:
            if idx % colNum == 0:
                ...
                DictPerformance_pp['0.0023'].append(List_Row[idx])


BoxPlotData_acc = [DictPerformance_acc['0.1'], DictPerformance_acc['0.05'],DictPerformance_acc['0.01'],DictPerformance_acc['0.0023']]
BoxPlotData_se = [DictPerformance_se['0.1'], DictPerformance_se['0.05'],DictPerformance_se['0.01'],DictPerformance_se['0.0023']]
BoxPlotData_spe = [DictPerformance_spe['0.1'], DictPerformance_spe['0.05'],DictPerformance_spe['0.01'],DictPerformance_spe['0.0023']]
BoxPlotData_pp = [DictPerformance_pp['0.1'], DictPerformance_pp['0.05'],DictPerformance_pp['0.01'],DictPerformance_pp['0.0023']]
...
plt.setp(ax, xticks = [1,2,3,4], xticklabels=['0.1','0.05', '0.01','0.0023'])
