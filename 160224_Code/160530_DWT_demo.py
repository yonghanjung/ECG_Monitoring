...
Normal_1 = ECG_train_dict[2294]
PVC_1 = ECG_train_dict[2488]
Normal_2 = ECG_train_dict[2956]

''' Wavelet decomposition before denoising '''
db8 = pywt.Wavelet('db8')
Normal_wc_1 = pywt.wavedec(data=Normal_1,wavelet=db8,mode='per',level=4 )
PVC_wc_1 = pywt.wavedec(data=PVC_1,wavelet=db8,mode='per',level=4 )
Normal_wc_2 = pywt.wavedec(data=Normal_2,wavelet=db8,mode='per',level=4 )

fig, axes = plt.subplots(3, 1, sharex=True)
fig = coef_pyramid_plot(Normal_wc_1[1:], ax=axes[0]) # omit smoothing coefs
fig = coef_pyramid_plot(PVC_wc_1[1:], ax=axes[1])
fig = coef_pyramid_plot(Normal_wc_2[1:], ax=axes[2])
...
# PVC_1_Coefs = pywt.wavedec(data=PVC_1,wavelet=db8,mode='per',level=4 )
# # PVC_1_Coefs = np.concatenate([PVC_1_Coefs[idx] for idx in range(len(PVC_1_Coefs))])
#
# Normal_Coefs_2 = pywt.wavedec(data=Normal_2,wavelet=db8,mode='per',level=4 )
# # Normal_Coefs_2 = np.concatenate([Normal_Coefs_2[idx] for idx in range(len(Normal_Coefs_2))])
#
# # cA4, cD4, cD3, cD2, cD1 = pywt.wavedec(data=Normal_1,wavelet=db8,mode='per',level=4 )
#
# # ######### denoising step #########
# # Wavelet_threshold = np.sqrt(2 * np.log(256)) * (np.median(np.abs(cD1 - np.median(cD1))) / 0.6745)
# # WaveletCoeffs = pywt.wavedec(data=Target_signal,wavelet=db8,mode='per',level=4 )
# # cA4, cD4, cD3, cD2, cD1 = map (lambda x: pywt.thresholding.soft(x,Wavelet_threshold), WaveletCoeffs)
# # ######### denoising step #########
#
# # Signal_info = [cA4, cD4, cD3, cD2, cD1]
# # denoised_signal = pywt.waverec(Signal_info,wavelet=db8,mode='per')
# # DWT_result = list()
#
# # for idx in range(len(Signal_info)):
# #     Temp = [0] * len(Signal_info)
# #     Temp[idx] = Signal_info[idx]
# #     for idx2 in range(len(Signal_info)):
# #         if idx != idx2:
# #             Temp[idx2] = np.zeros(len(Signal_info[idx2]))
# #     DWT_result.append(pywt.waverec(coeffs=Temp,wavelet=db8,mode='per'))


# ''' Drawing figure '''
# domain_1 = Time_domain[2294-128:2294+128]
# domain_2 = Time_domain[2488-128:2294+128]
# domain_3 = Time_domain[2294-128:2294+128]
#
# plt.figure(1, figsize=(20,8))
#
# ax_Normal_1_A4 = plt.subplot(531)
# ax_Normal_1_A4.vlines(domain_1/2,[0],Normal_Coefs_1[0],'b')
# ax_Normal_1_D4 = plt.subplot(534)
# ax_Normal_1_D4.vlines(domain_1/2,[0],Normal_Coefs_1[1],'b')
# ax_Normal_1_D3 = plt.subplot(537)
# ax_Normal_1_D3.vlines(domain_1/4,[0],Normal_Coefs_1[2],'b')
# ax_Normal_1_D2 = plt.subplot(5310)
# ax_Normal_1_D2.vlines(domain_1/8,[0],Normal_Coefs_1[3],'b')
# ax_Normal_1_D1 = plt.subplot(5310)
# ax_Normal_1_D1.vlines(domain_1/16,[0],Normal_Coefs_1[4],'b')
#
# plt.axhline(y=0.0, c='black')
# #
# # ax_PVC = plt.subplot(312)
# # ax_PVC.vlines(domain_1,[0],PVC_1_Coefs,'r')
# # plt.axhline(y=0.0, c='black')
# #
# # ax_Normal_2 = plt.subplot(313)
# # ax_Normal_2.vlines(domain_1,[0],Normal_Coefs_2,'b')
# # plt.axhline(y=0.0, c='black')
#
# plt.show()
#
...
# # ax_before.plot(Target_signal, label="Before denoising")
# # plt.legend()
# # ax_before.xaxis.set_visible(False)
# # ax_before.yaxis.set_visible(False)
# # plt.xlim(0,256)
# #
# # ax_after = plt.subplot(122)
# # ax_after.plot(denoised_signal, label="After denoising")
# # plt.legend()
# # ax_after.xaxis.set_visible(False)
# # ax_after.yaxis.set_visible(False)
# # plt.xlim(0,256)
#
# #
# #
...
# #
# # ax_orig = plt.subplot(611)
# # ax_orig.plot(Target_signal, label='Raw signal')
# # ax_orig.yaxis.set_visible(False)
# # ax_orig.xaxis.set_visible(False)
# # plt.legend(fontsize=20)
# # plt.xlim(0,256)
# #
# # ax_approx = plt.subplot(612)
# # ax_approx.plot(DWT_result[0], label="Approx at decomposition 4")
# # ax_approx.yaxis.set_visible(False)
# # ax_approx.xaxis.set_visible(False)
# # plt.legend(fontsize=20)
# # plt.xlim(0,256)
# #
# # ax_d1 = plt.subplot(613)
# # ax_d1.plot(DWT_result[1], label="Detail at decomposition 4")
# # ax_d1.yaxis.set_visible(False)
# # ax_d1.xaxis.set_visible(False)
# # plt.legend(fontsize=20)
# # plt.xlim(0,256)
# #
# # ax_d2 = plt.subplot(614)
# # ax_d2.plot(DWT_result[2], label="Detail at decomposition 3")
# # ax_d2.yaxis.set_visible(False)
# # ax_d2.xaxis.set_visible(False)
# # plt.legend(fontsize=20)
# # plt.xlim(0,256)
# #
# # ax_d3 = plt.subplot(615)
# # ax_d3.plot(DWT_result[3], label="Detail at decomposition 2")
# # ax_d3.yaxis.set_visible(False)
# # ax_d3.xaxis.set_visible(False)
# # plt.legend(fontsize=20)
# # plt.xlim(0,256)
# #
# # ax_d4 = plt.subplot(616)
# # ax_d4.plot(DWT_result[4], label="Detail at decomposition 1")
# # ax_d4.yaxis.set_visible(False)
# # ax_d4.xaxis.set_visible(False)
# # plt.legend(fontsize=20)
# # plt.xlim(0,256)
# # #
# # #
# # plt.tight_layout()
# # plt.savefig('Fig_DWT.eps',format='eps')
# #
# # # plt.show()
# # #
#
