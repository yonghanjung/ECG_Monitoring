...
def ECG_to_Wav(ECG_dict):
    ...
    for idx,key in enumerate(sorted(ECG_dict)):
        ...
        DetailCoefs = np.concatenate([Wav_dict[0], Wav_dict[key][1],Wav_dict[key][2],Wav_dict[key][3],Wav_dict[key][4]])
...
''' Drawing figure '''
plt.figure(1, figsize=(21,8))
av = plt.subplot(111)

# Normal 1 : 2294-200 to 2294 + 128
# PVC : 2294 + 129 to 2488 + 128
# Normal 2: 2488 + 128 to end
...
av.plot(Time_domain[start_1:end_1],ECG[start_1:end_1],'b')
av.plot(Time_domain[start_2:end_2],ECG[start_2:end_2],'r--')
av.plot(Time_domain[start_3:end_3],ECG[start_3:end_3],'b')
# plt.xlim(Time_domain[start],Time_domain[end])
av.yaxis.set_visible(False)

# text
av.text(6.19, 927.39, u'P', color = 'black', fontsize=20)
av.text(6.26, 777.40, u'Q', color = 'black', fontsize=20)
av.text(6.35, 1286.15, u'R', color = 'black', fontsize=20)
av.text(6.42, 777.40, u'S', color = 'black', fontsize=20)
av.text(6.64, 972, u'T', color = 'black', fontsize=20)
av.text(6.76, 859.37, u'Q', color = 'black', fontsize=20)
av.arrow(6.59,744.14,0.165,76.172, fc="k", ec="k",head_width=0.2, head_length=0.1 )
av.text(6.448, 701.98, u'No P wave', color = 'black', fontsize=20)
av.text(6.896, 1423.83, u'R', color = 'black', fontsize=20)
av.text(7.001, 812.5, u'S', color = 'black', fontsize=20)
av.text(7.159, 593.15, u'T', color = 'black', fontsize=20)
av.arrow(7.235,824.219,-0.055,-191.406, fc="k", ec="k",head_width=0.1, head_length=0.1 )
av.text(7.12, 837.891, u'Reverse T wave', color = 'black', fontsize=20)
av.text(8.046, 941.406, u'P', color = 'black', fontsize=20)
av.text(8.119, 804.688, u'Q', color = 'black', fontsize=20)
av.text(8.184, 1316.41, u'R', color = 'black', fontsize=20)
av.text(8.265, 796.875, u'S', color = 'black', fontsize=20)
av.text(8.50, 976.562, u'T', color = 'black', fontsize=20)

av.set_xlabel("Time (s)",fontsize=25)
# plt.xlim(Time_domain[start_1],Time_domain[end_3])
plt.xticks(fontsize=25)
# plt.yticks(fontsize=33)
plt.tight_layout()
# plt.savefig('Fig1_beat-comparison.eps',format='eps', dpi=1000, figsize=(21,8))
plt.show()
