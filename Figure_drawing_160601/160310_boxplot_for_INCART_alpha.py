...
BoxPlotData_acc = [DictPerformance_acc['0.25'],DictPerformance_acc['0.1'],DictPerformance_acc['0.05']]
BoxPlotData_se = [DictPerformance_se['0.25'],DictPerformance_se['0.1'],DictPerformance_se['0.05']]
BoxPlotData_spe = [DictPerformance_spe['0.25'],DictPerformance_spe['0.1'],DictPerformance_spe['0.05']]
BoxPlotData_pp = [DictPerformance_pp['0.25'],DictPerformance_pp['0.1'],DictPerformance_pp['0.05']]
...
ClassifierList = ['0.25','0.1', '0.05']
plt.setp(ax, xticks = [1,2,3,4], xticklabels=['0.25','0.1', '0.05'])
