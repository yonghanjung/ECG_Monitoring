...
av.set_xlabel("Time (s)",fontsize=30)
# plt.xlim(Time_domain[start_1],Time_domain[end_3])
plt.xticks(fontsize=30)

# text
# av.text(22.587, 1362, u'N', color = 'red', fontsize=20)
# av.text(23.15, 1515.62, u'V', color = 'red', fontsize=20)
# av.text(24.4549, 1362, u'N', color = 'red', fontsize=20)
# av.text(25.05, 1515.62, u'V', color = 'red', fontsize=20)
# av.text(26.351, 1362, u'N', color = 'red', fontsize=20)
# av.text(26.93, 1515.62, u'V', color = 'red', fontsize=20)
# av.text(28.12, 1362, u'N', color = 'red', fontsize=20)
# av.text(28.75, 1515.62, u'V', color = 'red', fontsize=20)
# av.text(30.00, 1362, u'N', color = 'red', fontsize=20)
# av.text(30.53, 1515.62, u'V', color = 'red', fontsize=20)

av.set_xlabel("Time (s)")

plt.savefig('Fig_Normal_PVC_illustration.eps',format='eps', dpi=1000, figsize=(21,8))
# plt.show()
